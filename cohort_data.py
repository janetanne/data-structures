...
def sort_by_cohort(filename):
    ...
    for person in file_object:
    	...
    	elif person_data[4] == "Winter 2016":
    		winter_16.append(person_name)

    	elif person_data[4] == "Spring 2016":
    		spring_16.append(person_name)

    	elif person_data[4] == "Summer 2016":
    		summer_16.append(person_name)

    	elif person_data[4] == "Fall 2015":
    		fall_15.append(person_name)

    all_students = [fall_15, winter_16, spring_16, summer_16]
    all_students_and_ghosts = [fall_15, winter_16, spring_16, summer_16, ghosts]

    return all_students_and_ghosts
...
def hogwarts_by_house(filename):
    ...
    for person in file_object:
    	person = person.strip()
    	person_data = person.split('|')
    	person_last_name = person_data[1]

    	if person_data[4] == "G":
    		ghosts.append(person_last_name)

    	elif person_data[4] == "I":
    		instructors.append(person_last_name)

    	elif person_data[2] == "Dumbledore's Army":
    		dumbledores_army.append(person_last_name)

    	elif person_data[2] == "Gryffindor":
    		gryffindor.append(person_last_name)

    	elif person_data[2] == "Hufflepuff":
    		hufflepuff.append(person_last_name)

    	elif person_data[2] == "Ravenclaw":
    		ravenclaw.append(person_last_name)

    	elif person_data[2] == "Slytherin":
    		slytherin.append(person_last_name)
...
def all_students_tuple_list(filename):
    ...
    for person in file_object:
    	...
    	if person_data[4] != "G" and person_data[4] != "I":
 	  		temp_list = [person_name, person_data[2], person_data[3], person_data[4]]
 	  		person_data = tuple(temp_list)
 	  		student_list.append(person_data)
